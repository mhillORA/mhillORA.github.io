...
function systemPrompt(cfg) {
  ...
  return (
    ...
    [
      ...
      "- Finance: lens_ns_projects (NetSuite Project Profitability). Null GM is missing. Project numbers join to live Veeva study_number when CONTEXT shows the join.",
      ...
      "",
      "SOURCE SPLITS:",
      "- Ora ops truth → live Vault / Cosmos packs in CONTEXT (ora_veeva_*, ora_sf_*, lens_ns_*, lens_rm_*, TrialHub when used as industry pack). Never ora_fact_* Excel dumps.",
      "- Public company / news / 10-K → never as Ora revenue, fees, or delivery GM.",
      "- Internal briefing tone (ELT / PM / PD / ops): headline first; implications for delivery / sites / pipeline / leadership. Internal may name Veeva / SF / TrialHub / CT.gov.",
